<%@ Page Title="Verify Phone Number" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="AgingConnecticut.Account.VerifyPhoneNumber" %>
 ...
 <h2><%: Title %>.</h2>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="Code" CssClass="col-sm-2 control-label">Code</asp:Label>
            <div class="col-md-10">
