<%@ Page Title="Two-Factor Authentication" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="AgingConnecticut.Account.TwoFactorAuthenticationSignIn" %>
    ...
    <asp:PlaceHolder runat="server" ID="verifycode" Visible="false">
        <section>
            ...
            <div class="form-group">
                <asp:Label Text="Code:" runat="server" AssociatedControlID="Code" CssClass="col-sm-2 control-label" />
                <div class="col-md-10">
